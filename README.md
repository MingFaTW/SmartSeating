...
SmartSeating is orginally a school project that developing for NPTU online exam platform ---  [PARTY](<https://party.nptu.edu.tw/>) used, as for designing seating chart and exam proctoring mode. As for the environment consideration, i switch to use the pure javascript on my school project. This React.js version will be my side project.
